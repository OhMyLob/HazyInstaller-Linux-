...
class GUI(Frame):
	def __init__(self):
		Frame.__init__(self)
		self.master.title("Hazy Installer - Device Chooser")
		w = 800
		h= 310
		...
		self.grid()
		self._button1 = Button(self, text = "Nexus 5", command = self._n5)
		self._button2 = Button(self, text = "Nexus 4", command = self._n4)
		self._image4 = PhotoImage(file = "n4-01.png")
		self._imageLabel4 = Label(self, image = self._image4)
		self._image = PhotoImage(file = "n5-01.png")
		...
		self.master.bind("<KeyRelease-Right>", lambda event: self._n4())
		self.master.bind("<KeyRelease-Left>", lambda event: self._n5())
	
	def _n5(self):
		self.master.destroy()
		os.system("python recoveryn5gui.py")

	def _n4(self):
		self.master.destroy()
		os.system("python recoveryn4gui.py")
